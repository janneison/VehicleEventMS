...
from app.infrastructure.adapters.database.repositories import (
    VehicleEventRepositoryImpl, VehicleRepositoryImpl, PeriodRepositoryImpl, SpecialRouteRepositoryImpl
)
from app.infrastructure.adapters.geolocation.Maps_adapter import GoogleMapsGeolocationAdapter
...
# Ensure your DATABASE_URL uses asyncpg (e.g., postgresql+asyncpg://...)
...
# Geolocation Service Singleton
geolocation_service: GeolocationService = GoogleMapsGeolocationAdapter() # Or NominatimGeolocationAdapter()
